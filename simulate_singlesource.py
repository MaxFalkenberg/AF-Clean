...
Simulation_type = input("Please the simulation type: ")
...
if Simulation_type == 'Delta':
    ...
    rp = int(input("Refractory Period: "))
    pulse_rate = int(input("Pulse Rate: "))
    sim_size = int(input("Time Steps: "))
    iteration_N = int(input("Number of iterations: "))
